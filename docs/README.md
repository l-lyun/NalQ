...
| Server | 학습자료 생성·조회·수정 | [학습자료 생성·조회·수정 TRD](../server/docs/trd/trd-learning-material-creation.md) | 구현 동기화 |
| Server | Notion 단일 페이지 일회성 복사 | [Notion 복사 TRD](../server/docs/trd/trd-notion-import.md) | OAuth 연결 생명주기 구현, 페이지 Search·복사 후속 |
